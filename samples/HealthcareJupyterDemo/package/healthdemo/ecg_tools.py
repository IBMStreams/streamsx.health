...
"""
    ...
    Modified from biosppy.signals.tools to remove dependency from matplot

    Required by ecg_streaming
...
def analytic_signal(signal=None, N=None):
    ...
    return ReturnTuple((amp, phase), ('amplitude', 'phase'))
...
def power_spectrum(signal=None,
    ...
    return ReturnTuple((freqs, power), ('freqs', 'power'))
...
def normalize(signal=None):
    ...
    return ReturnTuple((normalized,), ('signal',))
...
def zero_cross(signal=None, detrend=False):
    ...
    * When the signal crosses zero between samples, the first index
    ...
    return ReturnTuple((zeros,), ('zeros',))
...
def windower(signal=None,
    ...
    return ReturnTuple((index, values), ('index', 'values'))
...
def find_intersection(x1=None,
    ...
    * If no intersection is found, returns the closest point.
    ...
    return ReturnTuple((roots, values), ('roots', 'values'))
