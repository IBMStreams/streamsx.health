...
/* DEFWFDB is the default value of the WFDB path if the WFDB environment
   ...
   If WFDB_NETFILES support is disabled, the string ". /home/streamsadmin/physionet/wfdb-10.5.24/..//database" is
   usually sufficient for a default WFDB path, thus restricting the search for
   WFDB files to the current directory ("."), followed by /home/streamsadmin/physionet/wfdb-10.5.24/..//database).
...
# define DEFWFDB	". /home/streamsadmin/physionet/wfdb-10.5.24/..//database"
#else
# define DEFWFDB ". /home/streamsadmin/physionet/wfdb-10.5.24/..//database http://physionet.org/physiobank/database"
#endif
